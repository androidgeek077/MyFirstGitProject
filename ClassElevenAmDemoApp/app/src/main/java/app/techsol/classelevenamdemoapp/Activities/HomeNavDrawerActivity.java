...
import app.techsol.classelevenamdemoapp.Fragments.BarBQFragment;
import app.techsol.classelevenamdemoapp.Fragments.DashBoardFragment;
...
public class HomeNavDrawerActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_BarBQ) {
            FragmentLoadinManagerWithBackStack(new BarBQFragment());
